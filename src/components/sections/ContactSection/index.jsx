        ...
        <div className="card border-0 shadow-lg rounded-4 overflow-hidden">
          <div className="row g-0">
            ...
            <div className="col-lg-5 text-white p-4 p-md-5 d-flex flex-column justify-content-between bg-dark">
              ...
              <div className="mb-5">
                <h3 className="fw-bold mb-3 text-white">Lorem</h3>
                <p className="text-white-50">Lorem</p>
              </div>
            ...
            {/* <!-- Lado Direito: Formulário (Direct Email) --> */}
            <div className="col-lg-7 bg-white p-4 p-md-5">
              ...
              <form>
                <div className="row g-3">
                  ...
                  {/* <!-- Botão de Envio --> */}
                  <div className="col-12">
                    <button type="submit" className="btn btn-outline-secondary btn-lg w-100 rounded-pill fw-bold shadow-sm py-3 d-flex justify-content-center align-items-center gap-2">
